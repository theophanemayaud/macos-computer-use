...
Accessibility and Screen Recording belong to **the signed helper .app**, not the chat app or editor. Decline a sheet for those. Do not call Codex Computer Use from this stack. This MCP is the window’s pixels and accessibility tree.
